    ...
    <div className="footer-section">
      ...
      <footer className=" px-5 md:px-7 lg:px-10 py-16 text-white mx-auto flex flex-col md:flex-row max-w-7xl justify-between">
        <div className="mx-auto lg:mx-0 text-center lg:text-left">
          ...
          <p className="font-medium">
            Best Choice Smart Service Company
            <br /> Providing reliable tech since {new Date().getFullYear()}
          </p>
        </div>
        ...
        <div className="mx-auto lg:mx-0">
          ...
          <div className="icons flex space-x-5 mt-10 mx-auto">
            <Link
              className="text-3xl rounded-sm bg-secondary hover:bg-white duration-500 hover:text-secondary text-white p-2  shadow-lg"
              to="/"
            >
              {" "}
      ...
      <section>
        ...
        <h2 className="text-center text-white mt-3">
          Copyrignt all right reserved {new Date().getFullYear()}{" "}
        </h2>
        <h2 className="text-center text-white pb-10 pt-3">
          By{" "}
          <span className="uppercase font-extrabold text-[17px] text-secondary">
            Anisha Zahan
          </span>{" "}
        </h2>
      </section>
