          ...
          <div className="w-full lg:basis-6/12 ml-5 pr-3 lg:mr-0 lg:ml-10 space-y-3 ">
            ...
            <div className="font-semibold">
              ...
              <del className="text-secondary font-semibold">
                {" "}
                <FormatePrice price={price + 100000}></FormatePrice>{" "}
              </del>
            </div>
            <h2 className="uppercase font-semibold text-sm">
              Deal Of the day : <FormatePrice price={price}></FormatePrice>{" "}
            </h2>
            <p className="text-gray-800 text-sm">{description}</p>
            <div className="flex justify-between flex-wrap">
              <div className=" flex flex-col items-center">
                <p className="text-2xl text-primary font-bold bg-slate-300 p-2 rounded-full">
              ...
              <div className=" flex flex-col items-center">
                <p className="text-3xl mx-auto text-primary font-bold bg-slate-300 p-2 rounded-full">
                  <MdHelpCenter className="mx-auto"></MdHelpCenter>{" "}
                </p>
