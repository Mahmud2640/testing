...
const ShippingAndReturns = () => {
  return (
    <div className="bg-violet-100 pb-12">
      <div className="max-w-7xl mt-2 mb-16 pt-5 mx-auto px-5 md:px-10 lg:px-40">
        <h1 className="text-center text-xl font-semibold py-10">
          SHIPPING & RETURNS
        </h1>
        <p className="text-sm">
          To edit this page simply login to the control panel, click the Website
          Content tab and choose the View Web Pages option. Click Edit next to
          the Shipping & Returns page and you can change this text. A sample
          returns policy is shown below which you can edit as needed.
        </p>
        <h1 className="font-bold text-sm my-4">Returns Policy</h1>
        <p className="text-sm">
        ...
        <h1 className="font-bold text-sm my-4">Shipping</h1>
        <p className="text-sm">
